const COL_DEF_CONSTANTS = {
  ...
  dolp: { type: 'formattedDate', minWidth: 150 },
  hcola: { type: 'currency' },
  php: { minWidth: 265 },
  php1: { minWidth: 220 },
  orig_chg_off_amt: { type: 'currency' },
  smpa: { type: 'currency', minWidth: 140 },
  spc_com_cd: { minWidth: 175 },
  compl_cond_cd: { minWidth: 185 },
  cons_info_ind: { minWidth: 265 },
  cons_info_ind_assoc: { minWidth: 265 },
  previous_values__cons_info_ind: { minWidth: 265 },
  previous_values__cons_info_ind_assoc: { minWidth: 265 },
  ecoa: { minWidth: 230 },
  previous_values__ecoa: { minWidth: 230 },
  ecoa_assoc: { minWidth: 230 },
