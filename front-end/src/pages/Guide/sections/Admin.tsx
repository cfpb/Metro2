...
export default function Admin(): ReactElement {
  return (
    <div className='content-pad'>
      ...
      <img src={adminOne} alt='Step 1' className='image-border' />

      <Heading type='4'>Step 2</Heading>

      <Paragraph>Select the event you want to assign users to.</Paragraph>
      <img src={adminTwo} alt='Step 2' className='image-border' />
      ...
      <img src={adminThree} alt='Step 3' className='image-border' />

      <Heading type='4'>Step 4</Heading>

      <Paragraph>Press the “Save” button to save your changes.</Paragraph>
      <img src={adminFour} alt='Step 4' className='image-border' />
      ...
      <img src={adminFive} alt='Step 5' className='image-border' />
    </div>
  )
}
