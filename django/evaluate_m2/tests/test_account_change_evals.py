...
class AccountChangeEvalsTestCase(TestCase, EvaluatorTestHelper):
    ...
    # 2. l1__new_id_num == ''
        ...
        l1_activities = [
            {'id': 32, 'change_ind': '1', 'new_id_num':'', 'new_acc_num': ''},
            {'id': 34, 'change_ind': '2', 'new_id_num':'', 'new_acc_num': ''},
    ...
    # 2. l1__new_id_num != ''
        ...
        l1_activities = [
            {'id': 32, 'change_ind': '1', 'new_id_num':'2', 'new_acc_num': ''},
        ...
        expected = [{
            'id': 32, 'activity_date': date(2019, 12, 31),
            'cons_acct_num': '0032', 'l1__change_ind':'1',
            'l1__new_acc_num':'', 'l1__new_id_num': '2'
        }]
        self.assert_evaluator_correct(
