...
class EvaluatorResultFilterSet(django_filters.rest_framework.FilterSet):
    ...
    sort = django_filters.OrderingFilter(
        fields=(
            ...
            ("spc_pmt_ind", "k4__spc_pmt_ind"),
            ("deferred_pmt_st_dt", "k4__deferred_pmt_st_dt"),
            ("balloon_pmt_due_dt", "k4__balloon_pmt_due_dt"),
            ...
            ("prior_ecoa_assoc", "previous_values__ecoa_assoc"),
